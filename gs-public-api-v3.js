...
goog.provide('grooveshark.request');
/* Requires md5 as its hash function */
goog.require('md5hash');
 ...
 */
grooveshark.request = function(callbackclass) {
	/**@type {Grooveshark}*/this.callback = callbackclass;
	/**@type {md5hash}*/this.HMAC = new md5hash();  // HMAC (using MD5 as its hash function)
 ...
 */
grooveshark.request.prototype.getSubscriberStreamKey = function(songID, country, /*optional*/lowBitrate) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getSimilarArtists = function(artistID, /*optional*/limit) {
 ...
 */
grooveshark.request.prototype.voteDownAutoplaySong = function(song, autoplayState) {
 ...
 * @param {Object} autoplayState
 */
grooveshark.request.prototype.voteUpAutoplaySong = function(song, autoplayState) {
 ...
 */
grooveshark.request.prototype.startAutoplay = function(artistIDs, /*optional*/songIDs) {
 ...
 * @param {number} tagID
 */
grooveshark.request.prototype.startAutoplayTag = function(tagID) {
 ...
 * 
 */
grooveshark.request.prototype.getAutoplayTags = function() {
 ...
 * @param {Object} autoplayState
 */
grooveshark.request.prototype.getAutoplaySong = function(autoplayState) {
 ...
 * @param {Object} autoplayState
 */
grooveshark.request.prototype.markSongComplete = function(songID, streamKey, streamServerID, /*optional*/autoplayState) {
 ...
 */
grooveshark.request.prototype.markStreamKeyOver30Secs = function(streamKey, streamServerID, /*optional*/uniqueID) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getPopularSongsMonth = function(/*optional*/limit) {
 ...
 * @param {number} songID
 */
grooveshark.request.prototype.addUserFavoriteSong = function(songID) {
 ...
 */
grooveshark.request.prototype.removeUserFavoriteSongs = function(songIDs) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getUserFavoriteSongs = function(/*optional*/limit) {
 ...
 * @param {string} name
 */
grooveshark.request.prototype.renamePlaylist = function(playlistID, name) {
 ...
 */
grooveshark.request.prototype.setPlaylistSongs = function(playlistID, songIDs) {
 ...
 * @param {Array.<number>} songIDs
 */
grooveshark.request.prototype.createPlaylist = function(name, songIDs) {
 ...
 * @param {number} playlistID
 */
grooveshark.request.prototype.deletePlaylist = function(playlistID) {
 ...
 * @param {number} playlistID
 */
grooveshark.request.prototype.unsubscribePlaylist = function(playlistID) {
 ...
 * @param {number} playlistID
 */
grooveshark.request.prototype.subscribePlaylist = function(playlistID) {
 ...
 * 
 */
grooveshark.request.prototype.getUserPlaylistsSubscribed = function() {
 ...
 */
grooveshark.request.prototype.removeUserLibrarySongs = function(songIDs, albumIDs, artistIDs) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getUserLibrarySongs = function(/* optional */limit) {
 ...
 */
grooveshark.request.prototype.addUserLibrarySongsEx = function(songs) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getAlbumSongs = function(albumID, /* optional */limit) {
 ...
 * @param {number} artistID
 */
grooveshark.request.prototype.getArtistPopularSongs = function(artistID) {
 ...
 */
grooveshark.request.prototype.getArtistsInfo = function(artistIDs) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getSongSearchResults = function(query, country, /* optional */limit) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getAlbumSearchResults = function(query, /* optional */limit) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getPlaylistSearchResults = function(query, /* optional */limit) {
 ...
 */
grooveshark.request.prototype.getSongsInfo = function(songIDs) {
 ...
 * 
 */
grooveshark.request.prototype.logout = function() {
 ...
 */
grooveshark.request.prototype.registerUser = function(emailAddress, password, fullName, /* optional */username) {
 ...
 * 
 */
grooveshark.request.prototype.getUserInfo = function() {
 ...
 * @param {boolean} lowBitrate
 */
grooveshark.request.prototype.getStreamKeyStreamServer = function(songID, country, /* optional */lowBitrate) {
 ...
 * @param {string} ip
 */
grooveshark.request.prototype.getCountry = function(/* optional */ip) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getPopularSongsToday = function(limit) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getPlaylist = function(playlistID, limit) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getArtistSearchResults = function(query, limit) {
 ...
 * @param {number} artistID
 */
grooveshark.request.prototype.getArtistAlbums = function(artistID) {
 ...
 * @param {number} limit
 */
grooveshark.request.prototype.getUserPlaylists = function(/* optional */limit) {
 ...
 * @param {boolean} isMD5
 */
grooveshark.request.prototype.authenticate = function(username, password, isMD5) {
...
/**
  * Start a new session
  */
grooveshark.request.prototype.startSession = function() {
 ...
 */
grooveshark.request.prototype.generatePayload = function(method, /* optional */parameters, sessionIDRequired) { 
...
/**
  ...
  */
grooveshark.request.prototype.makeCall = function(method, payload, isHTTPS) {
...
/**
  ...
  * @return {string} url
  */
grooveshark.request.prototype.createPOSTURL = function(payload, isHTTPS) {
	/**@type {string}*/var url = "";
...
/**
  ...
  */
grooveshark.request.prototype.setSessionID = function(sessionID) {
...
/**
  ...
  */
grooveshark.request.prototype.checkSessionID = function() {
